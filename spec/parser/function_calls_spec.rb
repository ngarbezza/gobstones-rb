describe Gobstones::Parser, "function calls" do
  ...
  it "should parse a function call with one arg" do
    ...
    'func1(Verde)'.should be_parsed_to(expected)
  end
  ...
  it "should parse a function with many args" do
    ...
    'func1(42, nroBolitas(Verde), Norte)'.should be_parsed_to(expected)
  end
  ...
  it "should parse a complex function call" do
    ...
    'func1(a || b, 5*(10 div c), func2(Verde, opuesto(Norte)))'.should be_parsed_to(func1_call)
  end
